...
export const CREATE_PRODUCT_BY_ID_REQUEST = "CREATE_PRODUCT_BY_ID_REQUEST";
export const CREATE_PRODUCT_BY_ID_SUCCESS = "CREATE_PRODUCT_BY_ID_SUCCESS";
export const CREATE_PRODUCT_BY_ID_FAILURE = "CREATE_PRODUCT_BY_ID_FAILURE";
